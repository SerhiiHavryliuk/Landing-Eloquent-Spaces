...
function Datepicker() {
	...
	this._datepickerShowing = false; // True if the popups picker is showing , false if not
	...
	this._defaults = { // Global defaults for all the date picker instances
		showOn: "focus", // "focus" for popups on focus,
			// "button" for trigger button, or "both" for either
		showAnim: "fadeIn", // Name of jQuery animation for popups
