...
var FrondevoSubmitForms = function () {
    function FrondevoSubmitForms() {
        _classCallCheck(this, FrondevoSubmitForms);
        ...
        // форма подписки
        this.idFormSubscribe = 'form-1'; // здесь пишем id формы
    ...
    _createClass(FrondevoSubmitForms, [{
        key: '_initModules',
    ...
    return FrondevoSubmitForms;
}();

var submitForms = new FrondevoSubmitForms();